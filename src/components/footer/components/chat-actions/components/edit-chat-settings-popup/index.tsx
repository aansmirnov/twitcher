...
export const EditChatSettings = ({ onClose, isOpen, chatSettings, handleUpdateChatSettings }: EditChatSettingsProps) => {
    ...
    const changeFollowerMode = (value?: string | number) => {
        ...
        onChange({ follower_mode: isFollowerMode, follower_mode_duration: isFollowerMode ? value : null });
    };

    const changeSlowMode = (value?: string | number) => {
        const isFollowerMode = typeof value === 'number';
        onChange({ slow_mode: isFollowerMode, slow_mode_wait_time: isFollowerMode ? value : null });
    };
                    ...
                    <Flex flexDirection='column' gap={4}>
                        <Box>
                            ...
                            <Select
                                ...
                                maxMenuHeight={240}
                                value={{ value: chatSettings.follower_mode_duration ?? '', label: FOLLOWER_MODE_DURATION_LABEL_BY_VALUE[chatSettings.follower_mode_duration ?? ''] }}
                        ...
                        <Box>
                            ...
                            <Select
                                ...
                                maxMenuHeight={240}
                                value={{ value: chatSettings.slow_mode_wait_time ?? '', label: SLOW_MODE_LABEL_BY_VALUES[chatSettings.slow_mode_wait_time ?? ''] }}
